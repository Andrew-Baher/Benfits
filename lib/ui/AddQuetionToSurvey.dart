...
//questions.add(q);
class AddQuetionToSurvey extends StatefulWidget {
  @override
  _AddQuetionToSurveyState createState() {
    q = new Question();
    q.questionChoicesnumber = 0;
    q.questionType = false;
    q.questionChoice=new List<String>();
    return new _AddQuetionToSurveyState();
  }
}

class _AddQuetionToSurveyState extends State<AddQuetionToSurvey>
